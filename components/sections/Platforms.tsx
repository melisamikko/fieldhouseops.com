    ...
    <section className="py-20 bg-surface">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl font-bold text-primary">We Live Inside Your CRM</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div className="rounded-2xl border border-border bg-background p-8">
            <div className="text-2xl font-bold text-primary mb-1">GoHighLevel</div>
            ...
            <ul className="mt-6 space-y-2 text-sm text-primary/60">
          ...
          <div className="rounded-2xl border border-border bg-background p-8">
            <div className="text-2xl font-bold text-primary mb-1">HubSpot</div>
            <div className="text-xs font-semibold uppercase tracking-wider text-accent mb-4">
              Full Integration
            </div>
            <p className="text-muted text-sm leading-relaxed">
